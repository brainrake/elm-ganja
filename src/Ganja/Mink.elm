module Ganja.Mink exposing (MinkBasis(..), basisList, basisCount, basisName, Mink(..), zero, get, set, new, toString, fromList, toList, reverse, dual, conjugate, involute, mul, wedge, vee, dot, add, sub, smul, muls, sadd, adds, ssub, subs, norm, inorm, normalized)
