module Ganja.R2 exposing (R2Basis(..), basisList, basisCount, basisName, R2(..), zero, get, set, new, toString, fromList, toList, reverse, dual, conjugate, involute, mul, wedge, vee, dot, add, sub, smul, muls, sadd, adds, ssub, subs, norm, inorm, normalized)
{-| Clifford Algebra: R2
